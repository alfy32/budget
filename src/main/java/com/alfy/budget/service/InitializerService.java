...
public class InitializerService {
    ...
    public void addInitialBudgetsAndCategories() {
        ...
        if (budgets.isEmpty() && categories.isEmpty()) {
            Budget budget01 = budgetsService.add(Budget.create("Donations", 1418.75));
            Budget budget02 = budgetsService.add(Budget.create("Life Insurance", 90));
            Budget budget03 = budgetsService.add(Budget.create("Home & Auto Insurance", 208.33));
            Budget budget04 = budgetsService.add(Budget.create("Property Tax", 183.33));
            Budget budget05 = budgetsService.add(Budget.create("Car Registration", 33.33));
            Budget budget06 = budgetsService.add(Budget.create("Car Bills", 33.33));
            Budget budget07 = budgetsService.add(Budget.create("Gift", 273.33));
            Budget budget08 = budgetsService.add(Budget.create("Generous", 125.00));
            Budget budget09 = budgetsService.add(Budget.create("Bingo Chips", 50.00));
            Budget budget10 = budgetsService.add(Budget.create("Medical", 416.67));
            Budget budget11 = budgetsService.add(Budget.create("Bills & Utilities", 700));
            Budget budget12 = budgetsService.add(Budget.create("Groceries", 700));
            Budget budget13 = budgetsService.add(Budget.create("School Lunch", 100));
            Budget budget14 = budgetsService.add(Budget.create("Gas & Fuel", 200));
            Budget budget15 = budgetsService.add(Budget.create("Eating Out", 100));
            Budget budget16 = budgetsService.add(Budget.create("Food on Vacation", 30));
            Budget budget17 = budgetsService.add(Budget.create("Hotel", 60));
            Budget budget18 = budgetsService.add(Budget.create("Kid's Activities", 250));
            Budget budget19 = budgetsService.add(Budget.create("Clothing", 137.83));
            Budget budget20 = budgetsService.add(Budget.create("Pet Food", 50));
            Budget budget21 = budgetsService.add(Budget.create("Miscellaneous", 500));
